...
write_csv(to_country_emissions, file.path("/capstone/seamissions/checkpoint/emissions_leaving.csv"))
```
...
write_csv(from_country_emissions, file.path("/capstone/seamissions/checkpoint/emissions_coming.csv"))
```
