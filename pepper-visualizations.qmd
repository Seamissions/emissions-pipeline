...
ggplot(summary_data, aes(x = factor(year), y = total_emissions, fill = source)) +
 ...
 theme(
    plot.background = element_rect(fill = "#0b2232", color = "#0b2232"),  # Set plot background color
    panel.background = element_rect(fill = "#0b2232", color = "#0b2232"),  # Set panel background color
    axis.text = element_text(color = "white", size = 15),  # Set axis text color to white
    ...
    plot.title = element_text(color = "white", face = "bold", size = 20),  # Set plot title color to white
