...
full_emissions_fao_species <- read_csv(file.path("/capstone/seamissions/checkpoint/full_emissions_fao_species.csv"), show_col_types = FALSE)
...
## Emissions/Unit Catch Comparisons
