...
fao_catch <- read_csv(file.path("/capstone/seamissions/checkpoint/fao_cleaned_taxonomic_code.csv"), show_col_types = FALSE)
```
...
for (i in seq_along(regions)){
 ...
 # -------- TABLE 1 --------
  ...
  total_region_emissions <- full_join(total_region_broad_allocation, total_region_non_broad_allocation, by = c("zone", "year", "flag", "taxonomic_code")) %>%
    #filter(zone == 18) %>%
