...
# build in warning to detect other geometry types
...
#emissions_zones_exploded$area_exploded <- as.numeric(st_area(emissions_zones_exploded))
...
# check
sum(emissions_grid_sf$co2_mt) == sum(emissions_partitioned$prop_co2_mt)

(sum(emissions_grid_sf$co2_mt, na.rm = TRUE) - sum(emissions_partitioned$prop_co2_mt))/sum(emissions_grid_sf$co2_mt, na.rm = TRUE)

# 4% loss

sum(emissions_grid_sf$co_mt) == sum(emissions_partitioned$prop_co_mt)

(sum(emissions_grid_sf$co_mt, na.rm = TRUE) - sum(emissions_partitioned$prop_co_mt))/sum(emissions_grid_sf$co_mt, na.rm = TRUE)
