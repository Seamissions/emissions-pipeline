...
fao_capture_join_31 <- fao_capture_join %>%
  filter(area_code == "31") %>%
...
fao_zone_31_merged <- left_join(fao_zones_merged, fao_capture_join_31, by = c("zone", "year", "flag"), relationship = "many-to-many")

fao_zone_31_merged_no_geo <- fao_zone_31_merged %>%
  st_drop_geometry()

#write_csv(fao_zone_31_merged_no_geo, here("checkpoint", "catch_emissions_fao_zone_31.csv"))
