...
data_pathway <- "/home/emlab/projects/current-projects/ocean-ghg-fisheries/data/_targets_meds_data/process"
...
```{r}
fao_regions <- st_read(file.path(data_pathway, "fao_region_shapefile/World_FAO_Zones.shp"))
```
