...
st_write(emissions_zones, here("checkpoint", "emissions_zones.gpkg"))
st_write(emissions_zones, file.path("/capstone/seamissions/data/checkpoint/emissions_zones.gpkg"))
```
